            ...
            >
                ...
                <div className="flex-1 min-w-0">
                    <div className={`relative flex items-center px-3 h-[32px] border rounded ${isDarkMode ? 'bg-[#1b1a19] border-[#484644]' : 'bg-[#faf9f8] border-[#edebe9]'}`}>
                        ...
                        <button onClick={(e) => { e.stopPropagation(); onCopy(e); }} className={`absolute right-1 p-1.5 rounded transition-colors ${isCopied ? 'text-[#107c10]' : isDarkMode ? 'text-[#c8c6c4] hover:text-[#60cdff] hover:bg-[#323130]' : 'text-[#605e5c] hover:text-[#0078d4] hover:bg-[#f3f2f1]'}`}>
